...
public class ZigbeeCluster
{
    ...
    #region Attributes
    internal ReportAttribute Report<T>(ushort id, string name, ZigbeeType type, Func<ZigbeeReader, T> reader) =>
        new ReportAttribute<T>(this, id, name, type, reader);

    internal ReportAttribute Attribute<T>(ushort id, string name, ZigbeeType type, Func<ZigbeeReader, T> reader) =>
        new ReportAttribute<T>(this, id, name, type, reader); 
    #endregion
}
