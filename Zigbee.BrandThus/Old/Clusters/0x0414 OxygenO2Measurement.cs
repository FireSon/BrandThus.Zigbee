...
[Cluster(0x0414, "Oxygen (O2) measurement")]
public static class ZclOxygenO2Measurement
{
    private static readonly ZigbeeCluster zcl = new(typeof(ZclOxygenO2Measurement));

    #region Oxygen Information
