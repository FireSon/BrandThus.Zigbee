...
[Cluster(0x040C, "Carbon monoxyde (CO) measurement")]
public static class ZclCarbonMonoxydeCOMeasurement
{
    private static readonly ZigbeeCluster zcl = new(typeof(ZclCarbonMonoxydeCOMeasurement));

    #region Carbon monoxyde Information
